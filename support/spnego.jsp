...
<HTML>
<HEAD>
	<TITLE>Tomcat SPNEGO Information Page</TITLE>
	<%@ page import="javax.servlet.http.HttpUtils,java.util.Enumeration,org.ietf.jgss.*,net.sourceforge.spnego.*,java.security.Principal" %>
</HEAD>
<BODY>

<H1>Tomcat SPNEGO Information Page</H1>
...
<TR>
	<TH align=right>Kerberos Prinicipal Name:</TH>
	<TD><%= request.getUserPrincipal().getName() %></TD>
<TR>

<TR>
	<TH align=right>Kerberos Prinicipal Realm:</TH>
	<TD><% Principal principal = request.getUserPrincipal();
		if(principal instanceof SpnegoPrincipal) {
			SpnegoPrincipal spnegoPrincipal = (SpnegoPrincipal)principal;
			out.print(spnegoPrincipal.getRealm());
